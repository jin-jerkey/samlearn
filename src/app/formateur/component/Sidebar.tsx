...
const allMenuItems = [
  { icon: HomeIcon, label: "Tableau de bord", path: "/formateur/dashboard" },
  { icon: CogIcon, label: "Mes cours", path: "/formateur/cour" },
  { icon: UserPlusIcon, label: "Suivi élèves", path: "/formateur/suivi" },
  { icon: UserPlusIcon, label: "Mon profil", path: "/formateur/profil" },
];
